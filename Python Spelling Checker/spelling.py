...
root=Tk()
root.title("Spelling Checker Software@ne")
...
heading = Label(root,text="Spelling Checker Software",font=("Trebuchet MS",30,"bold"),bg="#dae6f6",fg="#364971")
...
spell=Label(root,font=("popins",20),bg="#dae6f6",fg="#364971")
